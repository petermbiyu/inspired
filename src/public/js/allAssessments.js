          ...
          <div
           ...
           <h2 class="text-[1.1rem] font-bold text-center mb-4 border-b-2 ">${assessmentCard.title.toUpperCase()}</h2>
              ...
              <div class="w-full flex mt-3 items-center justify-center text-center text-white font-semibold gap-3 ">
                <a href="/academic/assessment/${assessmentCard._id}"  class="btn-create w-[40px] leading-[40px] h-[40px] rounded-full cursor-pointer transition-all duration-300 ease hover:text-white hover:bg-cyan-800 border-2 text-cyan-800 "><i class="fa-solid fa-arrow-up-right-from-square"></i></a>
              </div>
