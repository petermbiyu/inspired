    ...
    if (data && data.success) {
      ...
      const cards = data.classes
        .map(
          (classData) => `
          <div
              class="relative w-80 h-70 p-4 my-8 bg-slate-50 rounded-[5px] shadow-[0px_6px_15px_0px_rgba(0,0,0,0.25)] shadow-gray-500/50"
            >
              ...
              <div class="my-2 w-full text-[1rem]">
                ...
                <div class="italic">Code: ${classData.classCode}</div>
                 <div class="italic">Assessment: ${classData.assessmentTitle}</div>
